...
public class InfraDatabaseUseCase {

  private InfraDatabaseRepository infraDatabaseRepository;

  public InfraDatabaseUseCase(InfraDatabaseRepository infraDatabaseRepository) {
  ...
  private Mono<Integer> createControlTableIfNotExists() {
    return infraDatabaseRepository.createControlTable(new MetaModel());
  }
